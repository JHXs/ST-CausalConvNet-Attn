...
def get_ids_for_tvt(hz):
    ...
    test_ids = []
    if hz == 0:
        days_in_months = [31, 30, 31, 31, 30, 31, 30, 31, 31, 28, 31, 30-14-3]  # May to April 24*7 预测 24*1 就 30-7-1
    else:
        days_in_months = [
            ...
            31, 28, 31, 15-14-3  # 2025.1 ~ 2025.4.15, 扣除滑动窗口消失的样本数量(time_step+预测多少时长)
        ]  # 2020.1.1 - 2025.4.15
    start_id = 0
